export default {
    ...
    gameCenter: 'ศูนย์เกม',
    gameDescription: 'คำอธิบายเกม',
    gameIntro: 'นี่คือเกมแบบโต้ตอบที่ขับเคลื่อนโดย Arcadia Node สนุกกับเกมและสัมผัสประสบการณ์การผสมผสานเทคโนโลยีบล็อกเชนกับเกมแบบดั้งเดิม',
